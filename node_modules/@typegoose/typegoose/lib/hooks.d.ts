...
export declare const pre: {
    <T>(method: RegExp | "init" | "validate" | "save" | "remove" | DR[], fn: PreFnWithDocumentType<T>): ClassDecorator;
    <T_1>(method: RegExp | "insertMany" | "count" | "find" | "findOne" | "findOneAndRemove" | "findOneAndUpdate" | "update" | "updateOne" | "updateMany" | QMR[], fn: PreFnWithQuery<T_1>): ClassDecorator;
};

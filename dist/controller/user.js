...
var UserController = (function () {
    ...
    UserController.prototype.findUser = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = ctx;
                        return [4, logic_1.logic.user.findUserByID(ctx.request.body.name)];
                    case 1:
                        _a.body = _b.sent();
                        return [2];
                }
    ...
    UserController.prototype.login = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = ctx.request.body, name = _a.name, pass = _a.pass;
                        _b = ctx;
                        return [4, logic_1.logic.user.login(name, pass)];
                    case 1:
                        _b.body = _c.sent();
                        return [2];
                }
